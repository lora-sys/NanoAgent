...
class ToolRegistry(IToolRegistry):
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        self.allow_shell_commands = self.security_config.get(
            "allow_shell_commands", False
        )
        self.allow_network_access = self.security_config.get(
    ...
    def _load_category(self, category: str) -> None:
        ...
        try:
            ...
            logger.info(
                f"Loaded category '{category}' with {len(self._tool_cache[category])} tools"
            )
    ...
    def execute(self, name: str, arguments: Dict) -> Any:
        ...
        try:
            ...
            logger.info(
                f"Executed tool {name}: {result[:100] if isinstance(result, str) else 'OK'}"
            )
            return result
        except Exception as e:
            ...
            if file_path:
                ...
                if allowed_extensions:
                    ...
                    if (
                        ...
                        and ext not in read_only_extensions
                    ):
